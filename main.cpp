...
// MerketPrice : Rs. 8K per 10K impressions
...
public:
    ...
    {
        fstream f;
        f.open("Instagram.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        ...
        // // << "\n"
        // << "price";
        // cin>> type >> name >>companyName>>tagLine>> quantity >> fixed >>price;
        f << "\n"
          << "type"
          << ","
          << "name"
          ...
          << "price"
          << "\n";
        f << type << "," << name << "," << companyName << "," << tagLine << "," << quantity
          << "," << price << "\n";
    }
...
// MerketPrice : Rs. 9K per 10K impressions
...
public:
    ...
    {
        fstream f;
        f.open("Meta.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        cout << "Company Name: " << companyName << endl;
        cout << "Tagline: " << tagLine << endl;
...
// Youtube ad revenues
// MerketPrice : Rs. 9K per 1K impressions
...
public:
    ...
    {
        fstream f;
        f.open("Youtube.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        cout << "Company Name: " << companyName << endl;
        cout << "Tagline: " << tagLine << endl;
...
public:
    ...
    {
        fstream f;
        f.open("VideoAd.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        cout << "Company Name: " << companyName << endl;
        cout << "Tagline: " << tagLine << endl;
...
public:
    ...
    {
        fstream f;
        f.open("LBand.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        cout << "Company Name: " << companyName << endl;
        cout << "Tagline: " << tagLine << endl;
...
public:
    ...
    {
        fstream f;
        f.open("Scroller.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        cout << "Company Name: " << companyName << endl;
        cout << "Tagline: " << tagLine << endl;
...
public:
    ...
    {
        fstream f;
        f.open("PosterAd.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        cout << "Company Name: " << companyName << endl;
        cout << "Tagline: " << tagLine << endl;
...
public:
    ...
    {
        fstream f;
        f.open("BillBoard.csv", ios::app | ios::out);
        cout << "Type: " << type << endl;
        cout << "Name: " << name << endl;
        cout << "Company Name: " << companyName << endl;
        cout << "Tagline: " << tagLine << endl;
...
int main()
{
    ...
    cout << "-------------------------" << endl;
    cout << "Welcome to Advertising Management System" << endl;
    cout << "\"Innovate Learning\"" << endl
         << endl;
    ...
    while (packageLoopControl)
    {
        ...
        case 1:
        {
            ...
            while (socialMediaLoopControl)
            {
                ...
                cout << " (Rs. 4,000 per 10,000 impressions)" << endl;
                cout << "2. Meta (Facebook) deal" << endl;
                cout << " (Rs. 4,500 per 10,000 impressions)" << endl;
                cout << "3. Youtube deal" << endl;
                cout << " (Rs. 7,000 per 1,000 impressions)" << endl;
        ...
        case 2:
        {
            ...
            while (tvLoopControl)
            {
                ...
                cout << " (Rs. 300/second)" << endl;
                cout << "2. L-Band Ad" << endl;
                cout << " (Rs. 10,000/day )" << endl;
                cout << "3. Scroller Ad" << endl;
                cout << " (Rs. 15,000/day )" << endl;
                cout << "Which deal are you interested in? " << endl
                     << "(Else press 0 to go back)" << endl
                     << "Enter your choice :";
                int tvChoice;
        ...
        case 3:
        {
            ...
            while (posterLoopControl)
            {
                ...
                cout << "Here are the following deals you can grab-" << endl
                     << endl;
                cout << "1. Poster" << endl;
                cout << " (Rs. 5.8/piece)" << endl;
                cout << "2. Billboard" << endl;
                cout << " (Rs. 80,500/piece )" << endl;
                cout << "Which deal are you interested in? " << endl
                     << "(Else press 0 to go back)" << endl
                     << "Enter your choice :";
                int pChoice;
                ...
                {
                    int unite = 0;
                    cout << "Enter Units(Number of pices) : ";
                    cin >> unite;
            ...
            else
            {
                ...
                while (checkoutLoopControl)
                {
                    ...
                    case 1:
                        ...
                        cout << "--------------------------" << endl;
                        cout << "Order confirmed. Thanks for choosing LPU Advertising System." << endl;
                        cout << "--------------------------";
                        break;
                    case 2:
